...
with st.sidebar:
    ...
    with st.form("add_form", clear_on_submit=True):
        ...
        cat = st.selectbox("תחום", ["לשכת המדענית משרד החינוך", "בייביסיטר מיוחד במינו", "מחקר איכותני", "מבוא לבריה"מ", "כריית נתונים", "פלסטינים", "קורס התמחות", "ועדת חוקה","בית","רפואה", "קניות"])
